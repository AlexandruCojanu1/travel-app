...
import { MapPin, Loader2, Navigation, List, Map as MapIcon } from "lucide-react"
import { motion, AnimatePresence } from "framer-motion"
import { useAppStore } from "@/store/app-store"
import { useSearchStore } from "@/store/search-store"
import { MapView } from "@/components/maps/map-view"
import { BusinessDrawer } from "@/components/maps/business-drawer"
import { BusinessListView } from "@/components/explore/business-list-view"
import { GlobalSearch } from "@/components/search/global-search"
import { QuickFilters } from "@/components/feed/quick-filters"
import { searchBusinesses, getBusinessesForMap, type MapBusiness } from "@/services/business.service"
...
export default function ExplorePage() {
  ...
  // Auto-open city selector if no city selected
  useEffect(() => {
    if (!currentCity) {
      openCitySelector()
    }
  }, [currentCity, openCitySelector])
