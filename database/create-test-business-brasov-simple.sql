-- =====================================================
-- CREATE: Test business in Brașov (SIMPLIFIED VERSION)
-- This script creates a business in Brașov with only essential columns
...
BEGIN
  ...
  -- Step 3: Create or update the business (only essential columns)
  IF business_id IS NULL THEN
    -- Business doesn't exist, create it with minimal required columns
