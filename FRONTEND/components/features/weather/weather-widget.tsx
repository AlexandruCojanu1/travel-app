...
import { getWeatherForecast, filterForecastForVacation, type WeatherDay, type WeatherForecast } from '@/actions/weather'
  ...
  useEffect(() => {
    ...
    async function loadWeather() {
      ...
      try {
        ...
        if (weatherData) {
          const filtered = await filterForecastForVacation(weatherData, vacationStartDate, vacationEndDate)
